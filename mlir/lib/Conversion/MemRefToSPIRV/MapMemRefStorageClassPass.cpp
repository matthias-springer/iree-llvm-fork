...
spirv::mapMemorySpaceToStorageClassForVulkan(unsigned memorySpace) {
...
Optional<unsigned>
spirv::mapStorageClassToMemorySpaceForVulkan(spirv::StorageClass storageClass) {
#define STORAGE_SPACE_MAP_FN(storage, space)                                   \
  case storage:                                                                \
    return space;
...
public:
  explicit MapMemRefStorageClassPass() {
    memorySpaceMap = spirv::mapMemorySpaceToStorageClassForVulkan;
  }
  explicit MapMemRefStorageClassPass(
      const spirv::MemorySpaceToStorageClassMap &memorySpaceMap)
      : memorySpaceMap(memorySpaceMap) {}
